...
import { resendVerificationEmail } from '@/utils/auth/authService';
      ...
      <div className="flex">
        ...
        <div className="ml-3">
          <p className="text-sm text-yellow-700">
            Your email address ({email}) is not verified. 
            Please check your inbox or spam folder for a verification email.
          </p>
          {message && (
            <p className="mt-2 text-sm font-medium text-yellow-700">{message}</p>
          )}
          <div className="mt-2">
            <button
